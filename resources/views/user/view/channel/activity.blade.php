...
@section('content')
    <div class="view-profile">
        ...
        <div class="navigation-body">
            <a href="/View/Channel/Activity/{{ $user->id }}" class=" c-fifth font-weight-bold mr-3 active">Activity</a>
            <a href="/View/Channel/Playlist/{{ $user->id }}" class="text-white font-weight-bold">Playlist</a>  
        </div>
