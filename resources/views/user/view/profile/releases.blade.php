...
@section('content')
    <div class="view-profile">
        ...
        <div class="navigation-header my-5 mx-3 d-flex">
            ...
            <h3>
                <a href="/View/Profile/Releases/{{ $user->user_name }}" class="text-white font-weight-bold active">Profile</a>
            </h3><br>
        </div>
        @include('user.view.profile._about', $user)
        <div class="navigation-body">
            <a href="/View/Profile/Releases/{{ $user->user_name }}" class="font-weight-bold mr-3 active c-fifth">Releases</a>
