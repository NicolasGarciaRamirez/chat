...
@section('content')
    <div class="view-profile">
        ...
        <div class="navigation-header my-5 mx-3 d-flex">
            ...
            <h3>
                <a href="/View/Profile/WorkHistory/{{ $user->id }}" class="text-white font-weight-bold active">Profile</a>
            </h3>
        </div>
        @include('user.view.profile._about', $user)
        <div class="navigation-body">
            <a href="/View/Profile/Releases/{{ $user->id }}" class="font-weight-bold mr-3 text-white">Releases</a>
            <a href="/View/Profile/Members/{{ $user->id }}" class="text-white font-weight-bold mr-3">Members</a>
            <a href="/View/Profile/WorkHistory/{{ $user->id }}" class="font-weight-bold mr-3 active c-fifth">Work History</a>
