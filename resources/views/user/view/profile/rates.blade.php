...
@section('content')
    <div class="view-profile">
        ...
        <div class="navigation-header my-5 mx-3 d-flex">
            ...
            <h3>
                <a href="/View/Profile/Rates/{{ $user->user_name }}" class="text-white font-weight-bold active">Profile</a>
            </h3>
        </div>
        ...
        <div class="navigation-body">
            ...
            <a href="/View/Profile/Rates/{{ $user->user_name }}" class="font-weight-bold active c-fifth mr-3">Rates</a>
        </div>
        <profile-rates />
    </div>
@endsection