...
@section('content')
    <div class="view-profile">
        ...
        <div class="navigation-header my-5 mx-3 d-flex">
            ...
            <h3>
                <a href="/View/Profile/Genres/{{ $user->user_name }}" class="text-white font-weight-bold active">Profile</a>
            </h3>
        </div>
        ...
        <div class="navigation-body">
            ...
            <a href="/View/Profile/Genres/{{ $user->user_name }}" class=" font-weight-bold mr-3 active c-fifth">Genres</a>
