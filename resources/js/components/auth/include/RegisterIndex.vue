<template>
    <section class="d-xl-flex justify-content-between">
        <div class="bg-third mr-5 border-danger p-4 text-center w-100 auth-type" v-if="type === 'Index'">
            ...
            <button class="btn bg-fifth my-5"><a href="/Register/Free" class="text-white no-underline">COUNT ME IN</a> </button>
        </div>
        ...
        <div class="bg-third mr-5 border-danger p-4 text-center w-100 auth-type" v-if="type === 'Index' || type === 'Free'">
            ...
            <button class="btn bg-fifth text-white my-5"><a href="/Register/Contributor" class="text-white no-underline">BECOME A CONTRIBUTOR</a></button>
        </div>
