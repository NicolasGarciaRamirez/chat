<template>
    <div class="modal fade register" role="dialog" aria-labelledby="ModalContributorSingup" aria-hidden="true" id="ModalContributorSingup">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content modal-border-white ">
                <div class="p-0">
                   <div class="bg-third flex-column text-white border-danger p-4 text-center content">
                        ...
                        <small class="c-fifth my-3 font-weight-bold">(You don’t pay until you earn)</small><br>
                        ...
                        <button class="btn bg-fifth text-white my-3 font-weight-bold" @click="showModalForm">BECOME A CONTRIBUTOR</button>
                    </div>
                </div>
            </div>
        </div>
