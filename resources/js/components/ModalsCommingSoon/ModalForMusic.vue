<template>
        <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalForMusic" aria-hidden="false" id="ModalForMusic">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content modal-border-white">
                    ...
                    <div class="modal-body d-flex flex-column text-center justify-content-center p-5">
                        ...
                        <img src="/images/commingsoon/music-companies.svg" alt="">
