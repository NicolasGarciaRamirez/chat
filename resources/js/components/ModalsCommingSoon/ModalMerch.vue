<template>
    <div class="modal fade" tabindex="-1000" role="dialog" aria-labelledby="ModalMerch" aria-hidden="true" id="ModalMerch">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content modal-border-white">
                ...
                <div class="modal-body d-flex flex-column text-center justify-content-center align-items-center p-2">
                    <h2 class="font-weight-bold text-white mb-2">COMING VERY SOON!</h2>
                    <img src="/images/commingsoon/merch.svg" alt="" width="150" height="150">
