    ...
    <section class="post mt-3">
        <div class="post-head bg-primary p-3 d-md-flex align-items-start justify-content-between">
            <div class="d-flex justify-content-between align-items-center post-user-actions order-md-2">
                <button class="bg-primary align-items-right">FOLLOW <img src="/images/icons/star.svg" class="c-fifth ml-3"></button>
                <button v-if="post.user.subscription_type == 'CONTRIBUTOR'" class="bg-primary border-danger d-md-down-none" @click="showModalSupport">SUPPORT 
                ...
                <button v-if="post.user.subscription_type == 'CONTRIBUTOR'" class="bg-primary border-danger d-md-down-none" @click="showModalReward">REWARD 
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <div class="post-body bg-primary">
            ...
            <div class="d-flex flex-column mt-1 content">
                <img :src="`/images/post/${ post.image }`"  alt="img-post" @click="showModalPost" class="cursor-point">
            </div>
            <div class="d-flex flex-row justify-content-between align-items-center pt-2 post-user-actions d-block d-xl-none">
