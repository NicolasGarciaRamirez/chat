        ...
        <div class="post-head bg-primary p-3 d-md-flex align-items-start justify-content-between">
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="d-flex flex-column pl-md-3">
                    <a :href="`/${post.user.username}/Profile/Rates`" class="text-white post-user-name">{{ post.user.profile_information ? post.user.profile_information.artistic_name : post.user.personal_information.full_name }} <img src="/images/icons/check.svg" alt="" class="check-icon"></a>
