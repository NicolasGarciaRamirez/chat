<template>
    <div>
        <div class="content-multimedia"  v-if="!btnShow && file.resource != null">
            <audio :src="`${file.resource}`" type="audio/mp3" controls :class="`w-100 box-shadow border-radius-30 animate__animated ${file.resource ? 'animate__bounceIn' : 'd-none'}`"/>
            <a href="#" class="btn-close" v-on:click.prevent="reset()">
        ...
        <div v-else class="text-center">
            <a href="#" class="btn content-icon btn-outline-light rounded-pill mx-auto" v-on:click.prevent="selectAudio()">
                Upload Audio
                <div class="icon">
...
<script>
    export default {
        ...
        methods:{
            ...
            reset(){
                this.btnShow = true
                this.$parent.fileInput.resource = null
                this.$parent.post.resource = null
                return true
            },
            store(){
                return true
