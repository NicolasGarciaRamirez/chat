                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <div class="img-upload">
                            <label for="input-sound" class="cursor-pointer">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 663 351" style="enable-background:new 0 0 663 351;" xml:space="preserve" heigth="auto">
                        ...
                        <div class="img-upload">
                            <label for="input-video" class="cursor-pointer">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 1430 1080" style="enable-background:new 0 0 1430 1080;" xml:space="preserve" heigth="auto">
