        ...
        <div class="post-body bg-primary" v-if="post.resource">
            <div>
                <div class="d-flex flex-column content img-fluid p-3" v-if="post.resource">
                    ...
                    <div :id="`waveform${post.token}`" @click="storeView" v-if="post.resource_type === 'audio'"></div>
