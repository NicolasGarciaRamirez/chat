<template>
    <section href="modalShare">
        <div class="modal fade pr-0" z-index="1050" role="dialog" aria-labelledby="modalShare" aria-hidden="true" id="modalShare" data-typeShare = 'npi'>
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
                <div class="modal-content modal-border-white p-3 mx-auto" style="max-width: 650px;">
                    ...
                    <div class="modal-body p-1">
                        <textarea class="form-control mb-3" cols="30" rows="10"></textarea>
