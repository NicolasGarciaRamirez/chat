<template>
    <section class="profile">
        <div style=" background: var(--second-color);">
            <div class="row navigation-body mx-auto pb-4 mb-4" style="max-width: 1000px;">
                <div class="col-12 col-lg-6">
                    <div class="navigation-body__content h-100 text-left mt-0  pt-3 px-3 pb-0 px-lg-5">
                        <h3 class="c-white font-weight-bold text-center">
                            Personal Details
            ...
            <div class="navigation-header">
                <div class="navigation-header__select-section bg-black">
                    ...
                    <h3 class="mb-0">
                        <a :href="`/${user.username}/Edit`" class="c-fourth font-weight-bold" style="border-radius:0 0 .6rem 0;">
