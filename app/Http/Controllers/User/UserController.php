...
class UserController extends Controller
{
    ...
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            $this->user = $user;
            $this->user->load('personal_information', 'social_auth', 'playlists.playlist_post.post.comments', 'followers.user.followers.user.personal_information', 'followers.user.followers.user.profile_information', 'followers.user.profile_information', 'followers.user.personal_information','posts.views' ,'posts.comments.comments.likes.user', 'posts.likes.user', 'posts.votes.user', 'profile_information.members', 'profile_information.releases', 'profile_information.worked_with');
            return $next($request);
        });
    }
