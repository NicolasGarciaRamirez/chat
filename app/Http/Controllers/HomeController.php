...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if (\Auth::check()) {
            $user = \Auth::user();
            $user->load('personal_information','profile_information','followers.user.profile_information','followers.user.personal_information','playlists.playlist_post.post.comments');
        }
